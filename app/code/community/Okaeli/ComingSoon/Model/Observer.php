...
class Okaeli_ComingSoon_Model_Observer
{
    ...
    public function redirectToComingSoon(Varien_Event_Observer $observer)
    {
        ...
        $regexp = ($helperComingSoon->getSpecificRedirection()) ? '^\/'.$helperComingSoon->getSpecificRedirection().'\/?$' : '^\/comingsoon\/?$';
        ...
        $targetUrl = ($helperComingSoon->getSpecificRedirection()) ? $helperComingSoon->getSpecificRedirection() : 'comingsoon';
